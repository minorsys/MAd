Public Class frmMasterEditPhone


    Private Sub frmMasterEditPhone_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private frm_MasterGrdPhone

    Public Sub SetSelectedPhone(ByVal number As String, ByVal f As frmMasterGrdPhone)
        '呼び出し元フォームを格納する
        frm_MasterGrdPhone = f
