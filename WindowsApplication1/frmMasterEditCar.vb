Public Class frmMasterEditCar
    ...
    Private frm_MasterGrdCar

    Public Sub SetSelectedCar(ByVal carnum As String, ByVal f As frmMasterGrdCar)
        '呼び出し元フォームを格納する
        frm_MasterGrdCar = f
        ...
        Me.Tbl_carTableAdapter.FillByCarcode(Me.PhoneNumDBDataSet.tbl_car, carnum)
