Public Class frmMasterEditStaff
    ...
    Private frm_MasterGrdStaff

    Public Sub SetSelectedStaff(ByVal staffid As String, ByVal f As frmMasterGrdStaff)
        '呼び出し元フォームを格納する
        frm_MasterGrdStaff = f
